pyinstaller --log-level=DEBUG ^
    ...
    --add-data="C:\Users\Luca\github\backCor\data\sampleData\sample_3_multi.txt;data\sampleData" ^
    --add-data="C:\Users\Luca\github\backCor\data\sampleData\sample_4_single.txt;data\sampleData" ^    
